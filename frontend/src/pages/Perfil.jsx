...
export default function Perfil() {
    ...
    // Cambiamos el límite a 150 caracteres para que el botón aparezca más fácil
    const PREVIEW_LENGTH = 150;
    const fullTranscript = mujer.transcripcion;
    const preview = fullTranscript && fullTranscript.length > PREVIEW_LENGTH
        ...
        <main className={styles.main}>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.info}>
                   ...
                   {mujer.es_seudonimo === 1 && (
                     <div className={styles.pseudonimoContainer}>
                       <p className={styles.pseudonimo}>(Pseudonimo)</p>
                       <p className={styles.pseudonimoExplicacion}>Nombre elegido por la entrevistada para proteger su identidad</p>
                     </div>
                   )}
